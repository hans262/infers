...
exports.toFixed = exports.Polygon = exports.Path = exports.Edge = exports.Point = void 0;
class Point {
    constructor(X, Y) {
        this.X = X;
        this.Y = Y;
...
class Edge {
    constructor(start, end) {
        this.start = start;
        this.end = end;
        if (start.contrast(end)) {
            throw new Error('边的两个端点不能相同');
        }
    }
    minXY() {
    ...
    testPointInsideEdge(pt) {
        if (this.testPointInEdge(pt)) {
            let min = this.maxXY();
            let max = this.maxXY();
