import { DataFormatter, IDataFormatter, IDataFormatterJSON } from './data-formatter';
import { randomFloat, zeros } from './utilities';
...
export class RNN {
  ...
  while (true) {
    ...
    states = [];
    ${statesRaw.join(';\n    ')};
    for (var stateIndex = 0, stateMax = ${statesRaw.length
